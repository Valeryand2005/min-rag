...
def truncate_context(context, tokenizer, question, max_length=None):
    if max_length is None:
        max_length = max_context_tokens_for_prompt(tokenizer, question)
...
def run_mini_rag(
    ...
    for item in tqdm(test_set, desc="mini-rag"):
        ...
        context = format_passages(top_chunks)
        context = truncate_context(context, tokenizer, question)
